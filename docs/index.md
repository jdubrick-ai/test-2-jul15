...
!!! info
    ...
    **Source Code Repository:** [https://github.com/jdubrick-ai/test-2-jul15](https://github.com/jdubrick-ai/test-2-jul15)

    **GitOps Repository:** [https://github.com/jdubrick-ai/test-2-jul15-gitops](https://github.com/jdubrick-ai/test-2-jul15-gitops)

# **Usage**

To access the test-2-jul15 application that was deployed using the Software Template, complete the following instructions:
